...
val TRANSLATIONS = ErrorMessageTranslations(
    no = ErrorMessageTranslation(
        ...
        skatteforholdOgInntektTranslation = SkatteforholdOgInntektTranslation(
            ...
            duMaOppgiEtGyldigBelopSomErStorreEnn0 = "Du må oppgi et gyldig beløp som er større enn 0",
            maaVelgeMinstEnInntektKilde = "Du må velge minst en arbeidsinntektkilde",
            maaVelgeMinstEnInntektType = "Du må velge minst en inntekttype",
            maaOppgiInntekt = "Du må oppgi inntekt",
    ...
    en = ErrorMessageTranslation(
        ...
        skatteforholdOgInntektTranslation = SkatteforholdOgInntektTranslation(
            ...
            duMaOppgiEtGyldigBelopSomErStorreEnn0 = "You must specify a valid amount greater than 0",
            maaVelgeMinstEnInntektKilde = "You must select at least one work income source",
            maaVelgeMinstEnInntektType = "You must select at least one income type",
            maaOppgiInntekt = "You must specify income",
