package no.nav.melosys.skjema.translations
...
val TRANSLATIONS = ErrorMessageTranslations(
    no = ErrorMessageTranslation(
        ...
        skatteforholdOgInntektTranslation = SkatteforholdOgInntektTranslation(
            ...
            maaVelgeMinsteEnArbeidsinntektKilde = "Du må velge minst en arbeidsinntektkilde",
            maaVelgeMinsteEnInntektType = "Du må velge minst en inntekttype",
            maaOppgiInntekterFraUtenlandskVirksomhet = "Du må oppgi inntekter fra utenlandsk virksomhet",
            maaOppgiInntekterFraEgenVirksomhet = "Du må oppgi inntekter fra egen virksomhet",
            inntekterFraUtenlandskVirksomhetSkalIkkeOppgis = "Inntekter fra utenlandsk virksomhet skal ikke oppgis",
            inntekterFraEgenVirksomhetSkalIkkeOppgis = "Inntekter fra egen virksomhet skal ikke oppgis",
    ...
    en = ErrorMessageTranslation(
        ...
        skatteforholdOgInntektTranslation = SkatteforholdOgInntektTranslation(
            ...
            maaVelgeMinsteEnArbeidsinntektKilde = "You must select at least one work income source",
            maaVelgeMinsteEnInntektType = "You must select at least one income type",
            maaOppgiInntekterFraUtenlandskVirksomhet = "You must specify income from foreign company",
            maaOppgiInntekterFraEgenVirksomhet = "You must specify income from own business",
            inntekterFraUtenlandskVirksomhetSkalIkkeOppgis = "Income from foreign company should not be specified",
            inntekterFraEgenVirksomhetSkalIkkeOppgis = "Income from own business should not be specified",
