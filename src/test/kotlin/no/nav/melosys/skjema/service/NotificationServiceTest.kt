...
class NotificationServiceTest : FunSpec({
    ...
    val mockArbeidsgiverNotifikasjonClient = mockk<ArbeidsgiverNotifikasjonClient>()
    ...
    val service = NotificationService(mockArbeidsgiverNotifikasjonClient, mockKafkaTemplate, brukervarselTopic, producerCluster, producerNamespace, producerApp)
