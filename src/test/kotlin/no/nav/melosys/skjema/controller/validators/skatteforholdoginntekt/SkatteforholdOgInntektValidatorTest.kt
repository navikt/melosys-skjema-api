...
class SkatteforholdOgInntektValidatorTest : BaseValidatorTest() {

    @Test
    fun `SkatteforholdOgInntektDto should be annotated with GyldigSkatteforholdOgInntekt`() {
        val annotation = SkatteforholdOgInntektDto::class.java.getAnnotation(GyldigSkatteforholdOgInntekt::class.java)
